...
world_age_map@data[["% 65+ (of total population)"]] <- cut(world_age_map@data[["% 65+ (of total population)"]],
 ...
 age_map <- mapCountryData(world_age_map,
                ...
                catMethod='categorical',
                mapTitle= 'Countries and The Percentage of People Over 65 in 2017',
                colourPalette='palette',
                oceanCol='lightblue',
                addLegend = T,
                missingCountryCol='white' )
...
However, as stated earlier, we were able to learn more about certain types of cancer being more common in specific countries. While those results were unintended, we were able to learn the valuable fact that there is no blanket case for cancer throughout the world, and many countries are affected in different ways. 
\
\
In addition, even though at first we could not find any evidence for the correlation between cancer deaths and urbanization, we followed our instinct and tried scaling our data down to cancer deaths by cancer type. And it paid dividends when we observed a both visually significant association between urban sprawl and deaths caused by lung cancer. We believe if we keep on trying with other cancer types, we will make more fascinating discoveries.

# Conclusion
One of the most notable takeaways are the types of cancer that are responsible for the most deaths. For example, in our data we saw that most cancer moralities around the world were due to tracheal, bronchus, and lung cancers. There are a variety of reasons why, for example smoking as well as emissions from fossil fuels. This leads into our other point of urban populations being more at risk to certain types of cancer, as people living in these urban areas are more likely to be around these emissions due to higher amounts of vehicles and other machinery. Considering that lung cancers are the most common types of cancer mortality, this hypothesis seems to be true, unless some aspect such as smoking is causing this increase. 
\
\
