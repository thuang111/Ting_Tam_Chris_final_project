...
=======
title: "“Cancer: The Rising Mortality Rate in Relation to Urbanization and Aging Population Around the World” "
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
...
=======
To start off, we wanted to paint the general picture of what cancer types are the most common on a global scale and on a national scale of a random country. We decided to choose the US since this is where we currently are.

```{r, echo = FALSE, fig.alt = "This line graph shows the top 5 types of cancer worldwide and the USA that have increased the most since 1990. The cancer with the highest growth rate is trachael, bronchus, and lunger cancer, having almost doubled since 1990. Colon and rectal cancer is similar, having gone up around 90% in the past 30 years worldwide. In comparison, the USA has both of those as their top 2 cancers with the highest growth rate, however they are closer to 30% and 15%, respectively.", fig.width=15, fig.height=7}
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
...
=======
This graph is what first brought to our attention the fact that trachael, bronchus, and lung cancers were the most common cancers to die from in the world. They were solidly the most common cancers by a large margin, with the next most common (colon and rectum cancer) only having around half of the deaths of lung cancer. Another notable part of this graph is that there are multiple types of cancer that had radical increases. Lung cancers, colon and rectum cancers, and breast cancers have almost doubled in mortalities from 1990 to 2019. This shows the importance of noting the types of cancers that are becoming more common, as they oftentimes have different treatments available compared to other forms of cancer. While it is easy to say that rates of cancer mortality are rising, it is important to see which kinds of cancer they are in order to identify the roots and whether this rise is correlated with increases in population or represents an actual increase in lethality.
\
We were curious to see which countries in the world have high cancer deaths per 1,000 people and to observe if those countries changed throughout the years so we specifically picked and plotted this information in 3 distinct years - 2000, 2008 and 2017, which correspond to the beginning, middle and the end of our time frame respectively.
\

```{r, echo = FALSE, fig.alt = "This bar chart shows the countries with top 5 cancer mortality rate per 1000 people in 2000, 2008, and 2017. Monaco has the highest mortality rate in all three time periods, being around 40% greater than second place each time. Serbia seems to have an increased mortality rate in recent years, having the second highest mortaility rate in 2008 and 2017.Denmark, Germany, and Hungary are the other countries that are seen multiple times on the bar graph, with both countries being off the chart in 2017.", fig.width=10}
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
...
=======
From the map above, we can see that in 2017 most of the Western countries experienced the highest cancer death rates. Although not clearly shown here, we have learned from before that out of the Western world, the Europe is the most heavily affected. We also observe that many countries in Africa and the Middle East have the lowest cancer death rates.
\
Furthermore, we dive deeper into the issue by plotting to see which specific types of cancer caused the most deaths in the top 6 countries.
```{r, echo = FALSE, fig.alt = "This bar graph combines two earlier graphs, those being the most common cancer deaths and the countries with the highest mortality rates per 1000 people. Trachael, bronchus, and lunger cancer deaths are shown to be the most common in these countires, with Monaco having almost two times more of these lung cancer deaths than the leading countries. Colon and rectal cancer mortalities also appear for every country during the years present on the graph, with breast cancer, pancreatic, and testicular being the others present. Japan is the country among the 5 with the highest rate of prostate cancer, and Monaco with pancreatic cancer.", fig.width=10}
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
fig2b <- cancer %>%
...
=======
From this graph, we can see the three most lethal types of cancer in six of the countries with the most cancer deaths per capita. We can see that for every country over the three years analyzed, tracheal, bronchus, and lung cancers remain the most common fatal cancer type. Interestingly, Monaco has some of the highest gaps between lung cancers and other forms of cancer. It is also important looking at this graph to think about which types of cancers are fatal compared to others. For example, rectal cancer is seen as one of the most deadly cancers as it almost solely affects the population over 50, a group more prone to dying from cancer in comparison to those younger than 50.

## Urbanization
In order to answer our second research question, we needed to determine whether or not there is a positive correlation between urban growth rate and cancer death rate.

```{r, fig.alt = "This graph uses the same three years (2000, 2008, and 2017) and ranks the top 5 countries per year by cancer deaths in their urban populations. There are countries that have appeared before, such as Serbia and Monaco, however they are less prominant. Barbados represents the biggest change from shifting from total population to urban population. Barbados is ranked 3rd, 1st, and 2nd per each year. Saint Lucia also skyrockets from not being present in 2000, 4th place in 2007, and 1st in 2017. Burundi also shows up 1st in 2000, however afterwads falls off the graph entirely.", fig.width=10}
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
...
=======
  This graph shows the value in breaking down the types of cancer as well as the countries. When compared to the initial graph of countries with the highest rates of cancer deaths per 1000 people, there are many of the same countries bar three. Burundi only appears once at #1, implying that there was a local epidemic that was solved by 2008. For Barbados and Saint Lucia, we can see in our next graph that these two countries weren't as affected by tracheal, bronchial, and lung cancers; rather they each had a specific type of cancer that seemed to be a local problem for the country. We were unable to learn much about what we wanted to with this graph, but it serves as a starting point for a more broad exploration into the analysis of more local groups of countries and unique problems they may face when it comes to cancer deaths. (Can someone explain the colors for fig3a in the graph above in this paragraph. I don't fully understand it.)


```{r, fig.alt = "Simiarly to fig2b, this graph shows the most frequent lethal cancers for the countries with the highest deaths per capita in urban areas. While lung cancers continue to be frequent, the three countries not present in fig2b each have a most lethal cancer different from the others. For Barbados, prostate cancer around 40% of the top 3 most lethal cancers, Burundi with cervical cancers, and Saint Lucia with prostate cancer.", fig.width=10}
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
fig3b <- cancer %>%
  rename(country_code = Code, year = Year) %>% 
...
=======
  labs(title = "Percent change of Cancer Death in the Top 5 Urbanizing Countries",
       y = "")+
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
    theme(legend.position = "bottom",
          plot.title = element_text(hjust = 0.5),
...
<<<<<<< HEAD
  labs(title = "Growth Rate of Cancer in the Bottom 5 Urbanizing Countries",
       y = "% Change in Cancer Deaths")+
=======
  labs(title = "Percent Change of Cancer Deaths in the Bottom 5 Urbanizing Countries",
       y = "")+
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
  theme(legend.position = "bottom",
          plot.title = element_text(hjust = 0.5),
...
Despite urban growth and overall cancer deaths not correlating, if we continue to take the characteristics of an urban society into consideration, we might find a relationship between urban growth and a cancer type suspected to associate with modernization. As a result, we chose to inspect lung cancer.
>>>>>>> 0ff791b9c6ecb5520774f8966f9b3b1f6aa81934
...
```{r, echo = FALSE}
=======
Indeed, even though there is not enough evidence to prove that total cancer death rate positively correlates with urban population growth, visually, lung cancer does have a positive relationship with urban growth rate. Intuitively, this makes sense because as the air quality in urban areas gets worse by the year, the risk of damaging cells in the lungs becomes greater for urban residents.
\
What we can learn from this is that it might be misleading to generalize that there is an association between urban growth and rising average cancer death. Nonetheless, if we narrow down to a specific type of cancer, there actually could exist such a correlation.  
...
\
=======
According to this Politico article: [Why you're more likely to die of cancer in Europe than America](https://www.politico.eu/article/cancer-europe-america-comparison/), aging population is listed as one of the major predictors for cancer deaths, along with variables such as smoking and high medical costs.
\
This also implies that examining the age of the country's population proves to be a better measure than using urban growth as it can predict with more accuracy on the world level, i.e when we average out the numbers) whereas urban growth is more picky in terms of what *specific type of cancer* it is used to predict.

# Limitations

| We did run into some limitations throughout the project. One of the largest problems we ran into was trying to manipulate the data to what we wanted. This was most apparent when we were investigating the most lethal cancer types by country, where we ended up graphing countries that either had epidemics of cancer or the countries from the list we found of countries with the highest cancer deaths per 1000 people. However, as stated earlier, we were able to learn more about certain types of cancer being more common in specific countries. While those results were unintended, we were able to learn the valuable fact that there is no blanket case for cancer throughout the world, and many countries are affected in different ways. 
